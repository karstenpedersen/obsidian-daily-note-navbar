...
exports.SampleSettingTab = exports.DEFAULT_SETTINGS = void 0;
...
var SampleSettingTab = /** @class */ (function (_super) {
    ...
    SampleSettingTab.prototype.display = function () {
        ...
        new obsidian_1.Setting(containerEl)
            ...
            .setPlaceholder(exports.DEFAULT_SETTINGS.dateFormat)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (value.trim() === "") {
                            value = exports.DEFAULT_SETTINGS.dateFormat;
                        }
        ...
        new obsidian_1.Setting(containerEl)
            ...
            .addText(function (text) { return text
            .setPlaceholder(exports.DEFAULT_SETTINGS.tooltipDateFormat)
            .setValue(_this.plugin.settings.tooltipDateFormat)
            .onChange(function (value) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (value.trim() === "") {
                            value = exports.DEFAULT_SETTINGS.tooltipDateFormat;
                        }
...
exports.SampleSettingTab = SampleSettingTab;
